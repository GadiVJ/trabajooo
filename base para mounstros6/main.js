function starClasification ()
{
    ...
    classifier = ml5.soundClassifier("https://storage.googleapis.com/tm-model/2d0U1iPIx/model.json", modelReady);
}
...
function gotResults(error, results){
    if (error) {
        ...
        if (results[0].label == "ruido de fondo") {
          ...
          img2.src = 'aliens-03.png';
          img3.src = 'aliens-04.png';
        } else if (results[0].label == "dedos") {
          img.src = 'aliens-01.png';
          img1.src = 'aliens-02.png';
          img2.src = 'aliens-03.gif';
          img3.src = 'aliens-04.png';
        } else if (results[0].label == "teclas") {
          img.src = 'aliens-01.png';
          img1.src = 'aliens-02.png';
          img2.src = 'aliens-03.png';
